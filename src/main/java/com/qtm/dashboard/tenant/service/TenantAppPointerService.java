...
public class TenantAppPointerService {
    ...
    @Transactional
    public TenantDto create(TenantAppPointerUpsertRequestDto request) {
    ...
    @Transactional
    public TenantDto update(Long id, TenantAppPointerUpsertRequestDto request) {
     ...
     */
    @Transactional(readOnly = true)
    public Optional<TenantDto> findByClientCode(String clientCode) {
