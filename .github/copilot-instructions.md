...
- In QTMDB/QRMDashboard tutti gli stili frontend condivisi o riusabili devono essere definiti in `frontend/src/styles.css`, salvo richiesta esplicita o reale necessità di override locale limitato a un singolo componente.
